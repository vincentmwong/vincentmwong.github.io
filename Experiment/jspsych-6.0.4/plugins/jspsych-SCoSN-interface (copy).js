    ...
    plugin.info = {
		...
		parameters: {
			...
			reqprof: {
				...
				array: true,
				pretty_name: 'RequiredProfiles',
				default: undefined,
				description: 'The profiles that the person is required to visit',
			},
		}
    }
...
<img src='animal-collection/png/"+imagename+".png'>"; /* style='width:auto;height:75px;cursor:pointer;'>";*/
		...
		var required_profiles = trial.reqprof;
		var required_profiles_maximum = 5;
